...
-   SSVS determined that surface effect is significant
...
-   Frequentist GLM estimates gives same result as conjugate vauge priors for Bayes
  - lacks shrinkage and are more extreme at tails
...
-   This is ok, but much better than a model that does not pool strength from the top players
    -   Vague model had accuracy of 55.9% but sensitivity of only 18.4%!!
...
- Normal hyperparameters extracted from summary statistics exactly, use mean and SD from summary of MCMC.list$statistics
